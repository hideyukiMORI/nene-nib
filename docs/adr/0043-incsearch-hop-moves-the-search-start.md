...
- 状態: 受理（設計席 2026-09-23・Issue #168。引き継ぎの「次の順」の 3 番目。向きと回数は hide の指示「Vim 準拠」（2026-09-23・D18 の補足）を受けて Vim のソースで確認済み・Issue #172。回数 2 以上の逆向きの hop の後の Enter が当たりに着く Nib の形は hide 承認・2026-09-23「リナの推しでいい」）
- 日付: 2026-09-23
- Issue: #168
