...
2026-09-15: Issue #1（Phase 0〜2）、#3（最初の縦切り・ADR 0007）、#5（見た目・ADR 0008）、#7（編集・ADR 0009）、#11（ファイル・ADR 0010）。2026-09-16: #13（UTF-16 の変換を core に 1 本化）、#16（速さ・ADR 0011）、#19（起動の内訳）、#22（Vim の最初の縦切り・ADR 0012）。起動すると枠なし窓（Snap と影は OS のまま）に Mica のタイトルバー、タブ 1 本と窓の操作、
